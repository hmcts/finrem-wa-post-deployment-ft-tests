...
# Use this script if you would like to run your finrem-wa-post-deployment-ft-tests against a lower environment except preview.
...
export AZURE_SERVICE_BUS_MESSAGE_AUTHOR=finrem-${FT_ENVIRONMENT}
export FINREM_VAULT_NAME=finrem-${FT_ENVIRONMENT}
