package uk.gov.hmcts.reform.finrempostdeploymentfttests.preparers;
...
import uk.gov.hmcts.reform.finrempostdeploymentfttests.util.BinaryResourceLoader;
...
public class DocumentManagementFiles implements Preparer {
    ...
    public Document uploadDocument(DocumentNames document) {
        ...
        if (maybeResource.isPresent()) {
            ...
            Headers headers = authorizationHeadersProvider.getFinremSystemUserAuthorization();
